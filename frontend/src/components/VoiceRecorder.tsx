...
export default function VoiceRecorder({
      ...
      "https://api.openai.com/v1/audio/transcriptions",
      {
        ...
        headers: {
          Authorization: `Bearer ${
            import.meta.env.VITE_REACT_APP_OPENAI_API_KEY || "your-api-key-here"
          }`,
        },
        body: formData,
      }
  ...
  return (
    <button
      ...
      className={`fixed bottom-4 left-1/2 transform -translate-x-1/2 text-white rounded-full p-4 shadow-lg z-50 ${
        isRecording
