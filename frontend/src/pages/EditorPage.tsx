            ...
            <CardContent className="space-y-3">
              ...
              <div className="space-y-2">
                ...
                <Button
                  ...
                  className="w-full bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white text-xs py-2 shadow-lg hover:shadow-green-500/25 transition-all duration-200"
                  size="sm"
                >
