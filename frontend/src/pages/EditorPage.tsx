    ...
    async function RequestAgent(query: string, type: string) {
        ...
        if (type !== "voice") {
            const dict = {
                ...
                "create pull request": "I want to create a pull request for my research paper with description: ",
                commit: "I want to commit my research paper to the repository with message: ",
                "create repository": "I want to create a repository for my research paper with name: ",
            };
