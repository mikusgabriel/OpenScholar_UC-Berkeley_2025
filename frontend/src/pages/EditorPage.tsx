    ...
    async function RequestAgent(query: string, type: string) {
        ...
        if (type !== "voice") {
            const dict = {
                ...
                "create pull request": "I want to create a pull request for my research paper with description: " + message,
                commit: "I want to commit my research paper to the repository with message: " + message,
                "create repository": "I want to create a repository for my research paper with name: " + message,
                "complete this research": "I want to complete this research.",
            };
                ...
                <div className="w-80 flex flex-col gap-4 overflow-y-auto rounded-2xl border border-gray-200/50 bg-white/60 backdrop-blur-sm p-3 shadow-md">
                    ...
                    <Card className="bg-white/70 backdrop-blur-sm border-white/20 shadow-lg shadow-purple-500/5">
                        <CardHeader className="pb-3">
                            <CardTitle className="text-gray-900 flex items-center gap-2 text-sm font-semibold">Repository Actions</CardTitle>
                        </CardHeader>
